            ...
            try:
                ...
                if self.use_precomp_lang_embed:
                    ...
                    if random.random() > self.cond_mask_prob:
                        lang_data = torch.load(content["instruction"], weights_only=False)
                        # Handle both dict format (with 'embeddings' key) and direct tensor format
                        if isinstance(lang_data, dict) and 'embeddings' in lang_data:
                            data_dict["lang_embed"] = lang_data['embeddings']
                        else:
                            data_dict["lang_embed"] = lang_data
                    else:
